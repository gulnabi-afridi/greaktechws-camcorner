        ...
        <Grid gutter={30} py={36}>
          ...
          <Grid.Col span={5}>
            <Box
              w="100%"
              h="100%"
              sx={{ position: "relative", border: "2px solid black" }}
            >
          ...
          <Grid.Col span={7} py={36}>
            <Flex direction="column" gap={20} align="start">
              <Text fz={27} tt="capitalize" fw={600} lh="32px" color="black">
                Canon EOS Rebel T7 24.1 Megapixel Digital SLR Camera with Lens -
                18 mm - 55 mm (Lens 1), 75 mm - 300 mm (Lens 2)
              </Text>
              <Text fz={18} fw={400} color="black" tt="uppercase">
                CAMCOR ITEM NO. 113008847 | MFG. PART NO. 2727C021
              </Text>

              {/* price + stock */}
              <Flex direction="column">
                <Flex justify="center" align="center">
                  <Text fz={27} fw={600} color={theme.other.colors.yellow}>
                    $499.99
                  </Text>
                ...
                {/* in stock */}
                <Text tt="uppercase" fz={18} fw={700} color="black">
                  in stock
                </Text>
              </Flex>
              {/* extend service argument */}
              <Flex direction="column" gap={10}>
                <Text fw={600} fz={18} color="black" tt="capitalize">
              ...
              <Flex gap={20} mt={16} justify="center" align="center">
                <NumberInput
                  styles={() => ({
                    input: {
                      fontWeight: 700,
            ...
            <Flex direction="column" gap={20} mt={16} w="100%">
              ...
              >
                ...
                {showDescription ? (
                  ...
                  <IconPlus cursor="pointer" color="white" size={30} />
                )}
              </Flex>
              {showDescription && (
                <Text
                  ...
                  sx={{ userSelect: "none" }}
                >
                  Ideal for mobile device users wanting to take the next step
                  with their photography, the EOS Rebel T7 camera combines
                  fantastic features with easy-to-use operation for high-quality
                  images you'll be proud to share. Harness the power of the EOS
                  Rebel T7's large 24.1 Megapixel CMOS sensor to realize your
                  potential for great shots. Share the memories with your
                  friends and family quickly and easily via built-in Wi-FiÂ® and
                  NFC technology. With the EOS Rebel T7's fast autofocus system,
                  you can capture every moment as it happens, viewing each shot
                  through the bright optical viewfinder. A range of additional
                  features, including a large LCD screen, Full HD video
                  recording and an on-board feature guide help you capture
        ...
        <Grid>
          <Grid.Col span={7} p={40}>
            <Flex direction="column" align="flex-start" gap={20}>
              ...
              <Grid gutter={16}>
                ...
                <Grid.Col span={7}>
                  <Flex direction="column" align="flex-start" gap={17}>
                    <Text fz={18} fw={500} color="black">
                      Canon EOS Rebel T7 24.1 Megapixel Digital SLR Camera with
                      Lens - 18 mm - 55 mm (Lens 1), 75 mm - 300 mm (Lens 2)
                    </Text>
                    {/* price */}
                    <Flex justify="center" gap={10} align="center">
                      <Text fz={22} fw={500} color="black">
                        $499.99
                      </Text>
                      <Text fz={16} fw={400} color="black">
                        ORIGINAL $599.99
          ...
          <Grid.Col span={5} p={40} bg="#F7F7F7">
            ...
            >
              ...
              >
                <Text fz={18} fw={500} color="black" tt="uppercase">
                  Subtotal:{" "}
                </Text>
                <Text fz={18} fw={500} color="black">
                  $499.99
              ...
              {/* Est. Total:  */}
              <Flex w="100%" justify="space-between" align="center">
                <Text fz={18} fw={700} color="black" tt="uppercase">
                  Est. Total:
                </Text>
