        ...
        <Container size="xl" h="100%">
          <Flex align="flex-end" justify="flex-start" h="90%">
            <Stack align="flex-start" justify="flex-end" w="50%">
              ...
              <Group spacing={10} className="clickable">
                <Text fz={18} fw={800} color={theme.other.colors.yellow}>
                  SHOP LENSES
                </Text>
                <IconChevronRight color={theme.other.colors.yellow} />
              </Group>
        ...
        <Container size="xl">
          <Flex direction={"column"} gap={40}>
            <Divider
              ...
              labelPosition="center"
              label={
                <Title pr={30} pl={30} order={2} fz={45} color="white">
                  Shop by Brand
                </Title>
              }
            />
              ...
              return (
                <Flex w={"100%"} direction={"column"}>
                  ...
                  <Flex
                    ...
                    px={20}
                  >
                    <Text fz={18} fw={700} tt="uppercase" color="black">
                      {item.categoryType}
                    </Text>
                  </Flex>
                  {/*  */}
                  ...
                  {item.categoryType === "price" ? (
                    <Flex direction={"column"} gap={26} py={16} px={20}>
                      {/* ===> inputs */}
